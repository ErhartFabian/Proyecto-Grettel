...
<head>
    ...
    <link rel="stylesheet" href="avcp.css">
    ...
    <div id="todo">
        <div id="contenedor">
            <table>
                ...
                <tr>
                  <td>Período de recuperación de la inversión
                    (en meses) </td>
                  <td>Cuantitativo</td>
                  <td><input type="text"></td>
                </tr>
              ...
              <div class="butup">
                <input type="button" value="Guardar valores">
              </div>
              <div class="butdown">
                <input type="button" value="Guardar Matriz">
              </div>
        </div>
    </div>
</body>
